 ...
 * readable (UNIX epoch time) formats. Username field expanded to
 * 16 characters.
 *
 * Sample output from last(1):
 * mcarpent  pts/8        10.125.101.119   Tue Mar  9 10:22 - 11:07  (00:45)
 *
 * Sample default output from first(1):
 * mcarpenter        pts/8        saturn           Tue Mar  9 10:22:35 2010 - Tue Mar  9 11:07:37 2010  (00:45)
 *
 * Sample output from first(1) with the -u flag:
 * mcarpenter        pts/8        saturn           1268126555 - 1268129257  (00:45)
 */
/*
...
#define    USAGE    "usage: first [-n number] [-f filename] [-a] [-u] [name | tty] ...\n"
...
static int    lines;
static char    timef[155]; /* MJC 155 == 128(orig) + 8(start time) + 19(end time) */
